...
def test_records(animal_ids):
    print("\n\n PRUEBAS DE OPERACIONES CON REGISTROS TÉRMICOS")
    
    if not animal_ids:
        print(" No hay animales para crear registros")
        return []
    
    print("\n1️ AGREGAR REGISTROS TÉRMICOS...")
    records_data = [
        {
...
def test_alerts(animal_ids):
    print("\n\n PRUEBAS DE OPERACIONES CON ALERTAS")
    
    if not animal_ids:
        print(" No hay animales para crear alertas")
        return []
    ...
    print("\n5️ VERIFICAR ALERTAS DESPUÉS DE RESOLVER...")
